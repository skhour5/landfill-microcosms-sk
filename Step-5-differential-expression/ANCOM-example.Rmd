...
otu_data = read_tsv("ANCOM-master/data/moving-pics-table.tsv", skip = 1)
otu_id = otu_data$`feature-id`
otu_data = data.frame(otu_data[, -1], check.names = FALSE)
rownames(otu_data) = otu_id

meta_data = read_tsv("ANCOM-master/data/moving-pics-sample-metadata.tsv")[-1, ]
...
write_csv(res$out, "res_moving_pics.csv")
...
res_example <- read.csv("res_moving_pics.csv")
