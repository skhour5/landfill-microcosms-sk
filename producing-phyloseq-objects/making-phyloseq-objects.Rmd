...
This chunk of code is from Drmd's script
...
vst_all = phyloseq(vst_trans_count_tab, all_metadata, taxid, phy_tree(all_fitGTR$tree))
...
ps_all = phyloseq(otu_table(nochim_seqtab.all, taxa_are_rows = FALSE), sample_data(all_metadata), tax_table(taxid), phy_tree(all_fitGTR$tree))
...
saveRDS(vst_all, file = "../data/vst_all")
saveRDS(ps_all, file = "../data/ps_all")
...
all = readRDS("../data/vst_all")
vst_all = readRDS("../data/all")
