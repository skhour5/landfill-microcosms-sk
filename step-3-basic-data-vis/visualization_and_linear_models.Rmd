...
We also try our hand at linear models, however, these are likely not the best statistical tools for 16s data. Step 4; ordination, and Step 5; differential expression, are probably better tools to get some statistical power behind our results. 
...
This is the dataset used first, but I will also run some chunks with the other phyloseq objects created in step 2, depending on what I would like to do
